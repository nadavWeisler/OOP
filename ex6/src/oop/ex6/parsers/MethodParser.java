...
public class MethodParser extends Parser {
    ...
    public void parseMethod(ArrayList<String> methodLines, HashMap<String, Method> existingMethods)
        ...
        for (int i = 1; i < methodLines.size() - 1; i++) {
            ...
            if (this.isIfLine(line)) {
                ArrayList<HashMap<String, HashMap<String, Property>>> allProperties = getAllProperties(blocks, i);
    ...
    private ArrayList<HashMap<String, HashMap<String, Property>>> getAllProperties(ArrayList<BlockParser> blocks, int i) {
